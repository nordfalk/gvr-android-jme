 ...
 */
public class JaimeActivity extends AndroidGvrHarness implements GvrView.StereoRenderer {

  private static final String TAG = "JaimeActivity";
  ...
  public JaimeActivity() {
    super();
    appClass = TestJaime.class.getCanonicalName();
  }
